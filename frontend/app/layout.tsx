    ...
    <html lang="en" className={inter.className}>
      <body className="bg-gray-950 text-gray-100 min-h-screen">
        ...
        <header className="sticky top-0 z-50 bg-gray-900/80 backdrop-blur-xl border-b border-gray-800">
          <nav className="max-w-7xl mx-auto px-6 flex items-center justify-between h-14" aria-label="Main navigation">
            ...
            <div className="flex items-center gap-5 text-sm">
              ...
              <Link href="/api/export" className="text-gray-300 hover:text-white transition-colors">Export Companies</Link>
              <Link href="/api/export-contacts" className="text-gray-300 hover:text-white transition-colors">Export Contacts</Link>
              <Link href="/api/results" className="text-gray-300 hover:text-white transition-colors">API</Link>
            </div>
          </nav>
        </header>
        ...
        <footer className="text-center py-6 mt-10 border-t border-gray-800 text-gray-500 text-xs">
